...
- Lab: Solutions.
- Lab: Financial Tracker.
- Archive or omit until fixed: Recipe Tracker.
...
Repository URL: https://github.com/affanndm/Financial_Tracker

Live URL: None.

Purpose: Command-line finance tracker that records transactions to CSV, creates budgets, and calculates remaining budget by category.

Ownership classification: Likely sole build, pending alias confirmation.

Affan's relationship to the project: Repository owner; all commits use `IdontReallyKnowWhat <nadeemaffan23@gmail.com>`, which likely maps to Affan but requires confirmation before public attribution.

What the team collectively built: No public evidence of a team.

Verified personal contributions:

- Likely authored CLI flow, CSV persistence classes, budget calculations, and shared input validation.

Relevant commits:

- https://github.com/affanndm/Financial_Tracker/commit/17a5b11e7e26b0fd3af316e5e06024704069986c
- https://github.com/affanndm/Financial_Tracker/commit/0f8f53943a399a01502b77c91358c64a75b94bf4
- https://github.com/affanndm/Financial_Tracker/commit/700a10474b285fa641bd5ae927b1758e0cf1869e

Relevant pull requests: None noted.

Files and systems personally touched:

- `main.py`, `budget.py`, `transactions.py`, `uni_val.py`, CSV record files.

Technologies personally used:

- Python, CSV persistence, object-oriented programming, CLI input validation.

Strongest portfolio angle:

Early data-system exercise: transactions becoming usable budget information.

Recommended placement: Lab.

Missing information:

- `NEEDS_AFFAN_CONFIRMATION`: Confirm `IdontReallyKnowWhat <nadeemaffan23@gmail.com>` is Affan.
- `NEEDS_AFFAN_CONFIRMATION`: Whether the current CLI runs successfully.

Recommended media:

- Terminal recording if the project runs.
- Small diagram of transaction -> CSV -> remaining budget by category.

Cautions:

- Do not claim production-ready behavior, bank integration, charts, authentication, or database features.
- Audit notes found likely runtime issues; verify before showing live demo.
...
Repository URL: https://github.com/affanndm/Recipe-Tracker

Live URL: None.

Purpose: Command-line recipe tracker intended to develop OOP skills.
...
- Built intended OOP structure around recipes, shopping/search helpers, validation, configuration, and ingredient CSV data.

Relevant commits:

- https://github.com/affanndm/Recipe-Tracker/commit/fec2698b62c57075aa1993faff6d6e7c0a21bd72
- https://github.com/affanndm/Recipe-Tracker/commit/6e182790bc82ea8defbe65b6acc6d7bd428ce438
- https://github.com/affanndm/Recipe-Tracker/commit/f32c155ba240a80ce2b213a4aabeee23342b7894
- https://github.com/affanndm/Recipe-Tracker/commit/dbad3eaa56b104a3805d23a28531aadeee5097b7

Relevant pull requests: None noted.

Files and systems personally touched:

- `main.py`, `recipe.py`, `shopping.py`, `validation.py`, `config.py`, `Ingredients.csv`.

Technologies personally used:

- Python, pandas, CSV, OOP, CLI validation.

Strongest portfolio angle:

Early OOP learning artifact.

Recommended placement: Archive or omit until fixed.

Missing information:

- Current public source contains unresolved merge-conflict markers in multiple files.
- `NEEDS_AFFAN_CONFIRMATION`: Whether to fix and include as Archive, or omit entirely.

Recommended media:

- None until merge conflicts are resolved.
