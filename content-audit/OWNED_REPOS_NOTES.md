...
Refresh note, 2026-07-16: repositories that Affan moved to private are excluded from this public-facing audit and from the portfolio content model.
...
- Public repository discovery is a point-in-time snapshot; projects that are no longer public are intentionally omitted.
- Commit authorship was inspected only for repositories that remain intentionally public.
